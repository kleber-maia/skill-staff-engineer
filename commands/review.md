...
Fix surviving findings, apply SAFE and CAREFUL cleanups with `verify --mode fast` between them, report RISKY ones, then run `node .staff-engineer/cli.mjs review done --found <n> --fixed <n> [--reported <n>]`.
